        ...
        <div className='h-[685px] overflow-y-auto'>
            <div className='bg-[#212322]'>
                ...
                <div className='flex justify-center mt-4'>
                        <div className='w-[320px] h-[50px] flex items-center justify-center bg-[#D15439] rounded-3xl'>
                            <div className='flex items-center'>
                            <Draggable axis="x" bounds="parent" onStop={handleSwipeRight}>
                                <div className='ml-2 h-[40px] w-[40px] bg-white rounded-full'>
                                    <p className='text-xs mt-[12px] ml-1 text-[#D15439]'>Track</p>
                                </div>
                                </Draggable>
                ...
                <div className='flex flex-row w-[325px] h-[250px] bg-[#282828] mt-10 ml-5 rounded-2xl'>
                    ...
                    <div className='flex flex-row ml-2 mt-4 h-[500px]'>
                        {
                            Graph.map((progress,i) => (
                                <div>
                                    <div key={progress.label} className="relative w-[13px] h-[220px] ml-4  rounded-sm overflow-hidden flex items-end">
